...
<html>
	...
	<body>
		...
		<title</title>
						...
						<p>Uma ferramenta simples para vendas e negociações comerciais.</p>
					</header>
					...
					<section class="wrapper style1">
						<div class="inner">
								...
								<div class="flex flex-2">
									...
									<div class="col col2">
										<h3>Negócio Gente Grande</h3>
										<p>O sistema Negócio de Gente Grande é uma plataforma de vendas on-line
										...
										interessa.</p>
										<a href="#" class="button">Aprenda mais</a>
									</div>
								</div>
						</div>
					</section>
